...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 🟢️ | 签到 | WEB | 阿里云盘(极简版) | https://www.aliyundrive.com | aliyundrive_light.js | 2023-07-30 | 否 | 是 | 签到，无推送功能 |
| 🟢️ | 签到 | WEB | 阿里云盘(多用户版)  | https://www.aliyundrive.com | aliyundrive_multiuser.js | 2023-07-30 | 是 | 是 | 签到 |
| 🟤 | 签到 | WEB | 百度贴吧 | https://tieba.baidu.com | tieba.js | 2023-07-30 | 是 | 是 | 签到 |
| 🟤 | 签到 | WEB | 吾爱论坛 | https://www.52pojie.cn | 52pojie.js | 2023-07-30 | 是 | 是 | 签到 |
| 🟢️ | 签到 | WEB | 有道云笔记 | https://note.youdao.com/ | noteyoudao.js | 2023-07-30 | 是 | 是 | 签到、领取空间 |
| 🟤 | 签到 | 移动端 | WPS(轻量版) | https://vip.wps.cn/ | wps_light.js | 2023-07-30 | 是 | 是 | 适用于手机端签到，不具备绕验证码功能 |
| 🟤 | 签到 | 客户端 | WPS(客户端版) | https://vip.wps.cn/ | wps_client.js | 2023-07-30 | 是 | 是 | 适用于PC端签到，需要手动兑换奖励 |
| 🟢️ | 签到 | 小程序 | WPS(稻壳版) | https://vip.wps.cn/ | wps_docker.js | 2023-07-30 | 是 | 是 | 适用于稻壳签到，自动领取每日PPT |
| 🟢️ | 签到 | WEB | 网易云游戏 | https://cg.163.com/ | wangyiyungame.js | 2023-07-30 | 是 | 是 | 签到 |
| 🟢️ | 签到 | WEB | 什么值得买 | https://www.smzdm.com/ | smzdm.js | 2023-07-30 | 是 | 是 | 抽奖 |
