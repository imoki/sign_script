/*
    ...
    环境变量值：填写cookie
    备注：需要AccessToken。
          APP用抓包工具抓取所需的值或者网页端获取所需得值。
          浏览器访问网页版中兴社区，F12 -> "NetWork"(中文名叫"网络") -> 按一下Ctrl+R ->appInfo -> accesstoken
          中兴社区网址：https://bbs.ztedevices.com
*/

const logo = "艾默库 : https://github.com/imoki/sign_script"    // 仓库地址
var sheetNameSubConfig = "ztebbs"; // 分配置表名称
var pushHeader = "【中兴社区】";
