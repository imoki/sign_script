...
let sheetNameSubConfig = "yhsh"; // 分配置表名称， （修改这里）
let pushHeader = "【永辉生活】";    // （修改这里）
...
function resultHandle(resp, pos){
    ...
    if(posHttp == 2 || qlSwitch != 1){  // 第二次进来时用
        ...
        {
            credit = resp["data"]["signrewardvo"]["credit"]
            content = "🎉 签到成功，获得" + credit +  "积分"
...
function execHandle(cookie, pos) {
    ...
    params = "?timestamp=" + timestamp + "&channel=android&platform=android&v=9.12.0.12&app_version=9.12.0.12&sellerid=&channelSub=&jysessionid=9d813fd8-366c-42a6-a409-b5097c14cc5e&brand=realme&model=RMX3562&os=android&osVersion=android31&networkType=WIFI&screen=2248*1080&productLine=YhStore&appType=h5&cityid=11&deviceid=" + deviceid +"&shopid=9637&memberid=962892903519470906&access_token=" + access_token
    url += params
