/*
    ...
    环境变量值：无
    备注：已移除自动领奖功能
          需要Cookie。cookie填写阿里云盘网页版中获取的refresh_token。F12 -> Application(中文名叫"应用程序") -> Local Storage(中文名叫"本地存储") -> token -> refresh_token
          阿里云盘网址：https://www.alipan.com
    参考：文中引用代码改编自https://www.52pojie.cn/thread-1869673-1-1.html
*/

var sheetNameSubConfig = "aliyun"; // 分配置表名称
var pushHeader = "【阿里云盘】";
