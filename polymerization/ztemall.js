...
function execHandle(cookie, pos) {
  ...
  // try {
    ...
    //   // data: data
    // });
    resp = HTTP.get(url2 + params, {headers: headers,});
    ...
    //   // data: data
    // });
    resp = HTTP.get(url3 + params, {headers: headers,});
    task_id_list = []  // 存放任务列表
    resp = resp.json()
    // console.log(resp)
    ...
    for(i=0; i<task_id_list.length; i++){
      ...
      //   headers: headers,
      // });
      resp = HTTP.get(url4 + params, {headers: headers,});
      resp = resp.json()
      // console.log(resp)
      // {"errorcode":20001,"msg":"invalid token","data":{}}
    ...
    //   headers: headers,
    // });
    resp = HTTP.get(url5, {headers: headers,});
    resp = resp.json()
    // console.log(resp)
    errorcode = resp["errorcode"]
    if(errorcode == 0)
