...
var sheetNameSubConfig = "en"; // 分配置表名称
var pushHeader = "【希沃白板】";
...
function resultHandle(resp, pos){
    ...
    if (resp.status == 200) {
      ...
      if(msg == "ok")
      {
        ...
        content = "🎉 已签到" + currentDay  + "天 获得" + lotteryRecord + " " +  signRecord + " ";
        messageSuccess += content
        // console.log(content);
      }else{
        content = "📢 " + msg + " 可能已经签到过了 ";
        messageSuccess += content
        // console.log(content);
      }
...
function execHandle(cookie, pos) {
    ...
    messageSuccess = "";
    messageFail = "";
    var url = "https://easinote.seewo.com/extend/apis?actionName=SIGN_LOTTERY";
