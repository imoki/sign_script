...
let sheetNameSubConfig = "ddai"; // 分配置表名称（修改这里，这里填表的名称，需要和UPDATE文件中的一致，自定义的）
let pushHeader = "【钉钉AI】";    //（修改这里，这里给自己看的，随便填）
...
function resultHandle(resp, pos){
    ...
    if(posHttp == 1 || qlSwitch != 1){  // 第1次进来时用
        ...
        // {
        //     code: 500,
        //     message: "Cannot read property 'checkInType' of undefined",
        //     requestId: ''
        // }
    ...
    if(posHttp == 3 || qlSwitch != 1){  // 第3次进来时用
        // {"message":"success","code":1000,"data":{},"requestId":""}
        // {"code":1002,"message":"今日已签到","requestId":""}
...
function execHandle(cookie, pos) {
  ...
  url = "https://api-wolai.dingtalk.com/v1/checkIn"; // 签到url（修改这里，这里填抓包获取到的地址）
