...
let sheetNameSubConfig = "xmc"; // 分配置表名称
let pushHeader = "【小木虫】";
...
function resultHandle(resp, pos){
    ...
    messageSuccess += "帐号：" + messageName + "执行签到";
    console.log("帐号：" + messageName + "执行签到");
...
function execHandle(cookie, pos) {
    ...
    var url = "https://mapi.xmcimg.com/bbs/memcp.php?action=getcredit&formhash=&getmode=1&creditsubmit=1";
    headers = {
      "Cookie": cookie,
