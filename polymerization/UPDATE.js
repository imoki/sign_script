...
// wps(打卡版)、golo汽修之家、阿里云盘（自动更新token版）
// 宽带技术网、中兴商城、万能福利吧
// 废文小说、鸿星尔克、钉钉AI、爱奇艺
...
var configContent = [
  ...
  ['flyert', '飞客茶馆', '否', '是', '否' , '' , '' , '', '@all' , '是' , '否' ,],
  ['jyw', '菁优网', '否', '是', '否' , '' , '' , '', '@all' , '是' , '否' ,],
  ['ydwx', '一点万象', '否', '是', '否' , '' , '' , '', '@all' , '是' , '否' ,],
  ['ddai', '钉钉AI', '否', '是', '是' , '' , '' , '', '@all' , '是' , '否' ,],
  ['klingai', '可灵ai', '否', '是', '否' , '' , '' , '', '@all' , '是' , '否' ,],
  ['oray', '贝锐阳光小店', '否', '是', '否' , '' , '' , '', '@all' , '是' , '否' ,],
]
