...
let sheetNameSubConfig = "tianrun"; // 分配置表名称
let pushHeader = "【甜润世界】";
...
function execHandle(cookie, pos) {
  ...
  try {
    var url1 = "https://m.ahzyssl.com/applet/user/signIn "  // 签到日志："https://m.ahzyssl.com/applet/user/signIn/getUserSignInLog";
    headers = {
    ...
    if (resp.status == 200) {
      ...
      if(code == 200){
        hb = resp["data"]["hb"]
        messageSuccess += "帐号：" + messageName + "签到成功,获得徽宝" + hb +  " "
      console.log("帐号：" + messageName + "签到成功,获得徽宝" + hb +  " ");
      }else
      {
